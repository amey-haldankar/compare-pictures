...
ColorPickerDialog.OnColorChangedListener {
	...
	protected void onCreate (Bundle savedInstanceState)
	{
		...
		if(getFirstRun(2))
		{
			Intent intentDemo = new Intent(PaintActivity.this,DemoActivity3.class);
	...
	public class MyView extends View {
		...
		public MyView (Context c)
		{
            ...
            .decodeFile("/mnt/sdcard/Pictures/MyCameraApp/snapImage.jpg",options);*/
		...
		protected void onSizeChanged (int w, int h, int oldw, int oldh)
		{
			...
			/*mBitmap = Bitmap.createScaledBitmap(mBackBitmap, mBackBitmap
                    .getWidth(), mBackBitmap.getHeight(), true);
		...
		{
			bmOverlay = Bitmap.createBitmap(bmp1.getWidth(), bmp1
		...
		class SaveBitmapped extends AsyncTask<Void, Void, Void>
		{
			...
			protected void onPostExecute (Void result)
			{
				...
				{
					String pathExt = Environment.getExternalStorageDirectory().toString();
					String path = pathExt + "/Pictures/MyCameraApp/" + filePublic + ".jpg";
	...
	public boolean onCreateOptionsMenu (Menu menu)
	{
		...
		menu.add(0, COLOR_MENU_ID, 0, R.string.menu_color).setShortcut('3', 'c');
		menu.add(0, EMBOSS_MENU_ID, 0, R.string.menu_emboss).setShortcut('4', 's');
		menu.add(0, BLUR_MENU_ID, 0, R.string.menu_blur).setShortcut('5', 'z');
		menu.add(0, RESET_MENU_ID, 0, R.string.menu_reset).setShortcut('5', 'z');
	...
	public void onBackPressed ( )
	{
		...
		AlertDialog.Builder alertbox = new AlertDialog.Builder(PaintActivity.this);

		alertbox.setMessage(R.string.unsaved_changes_text); // Message to be displayed

		alertbox.setPositiveButton(R.string.continue_btn,new DialogInterface.OnClickListener() {
		...
		alertbox.setNegativeButton(R.string.cancel_btn, new DialogInterface.OnClickListener() {
